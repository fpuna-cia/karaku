...
insert into test (id, description, costo, fecha, bigdecimal) values (7, 'PERO',     225, '2013-12-19',     1287);

--Relleno para que los hijos sean 1-1 //?????\\
insert into test (id, description, costo, fecha, bigdecimal) values (8, 'PETOTE',   225, '2025-12-20',     1288);
insert into test (id, description, costo, fecha, bigdecimal) values (9, 'TOTE',     225, '2025-12-21',     1289);
