...
INSERT INTO encuesta_plantilla(id, fecha_creacion, usuario_id, activo, descripcion, key)VALUES (500000, '2014-05-06 00:00:00-04', 'ROOT', 'SI','descripcion', 'KEY1');
...
INSERT INTO encuesta_plantilla_pregunta(id, encuesta_plantilla_bloque_id, tipo_objeto_id, descripcion, orden, obligatoria, tag, longitud_respuesta, editable)VALUES (500005, 500000, 2, 'PAIS', 4, 'SI', 'direccion_numero', 300, 'SI');

--Tabla: opcion_respuesta
INSERT INTO opcion_respuesta(id, descripcion, orden, completar, encuesta_plantilla_pregunta_id)VALUES (500000, 'FEMENINO', 1, 'NO', 500002);
INSERT INTO opcion_respuesta(id, descripcion, orden, completar, encuesta_plantilla_pregunta_id)VALUES (500001, 'MASCULINO', 2, 'NO', 500002);
INSERT INTO opcion_respuesta(id, descripcion, orden, completar, encuesta_plantilla_pregunta_id)VALUES (500002, 'PARAGUAY', 1, 'NO', 500005);
INSERT INTO opcion_respuesta(id, descripcion, orden, completar, encuesta_plantilla_pregunta_id)VALUES (500003, 'COLOMBIA', 2, 'NO', 500005);
...
--Tabla: encuesta_detalle_opcion_respuesta
