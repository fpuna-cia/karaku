 ...
 * <p>
 * Los test que desean tener un script de inserci贸n de datos para pruebas deben
 * heredad de esta clase. Autom谩ticamente todos los test son isolados, es decir,
 * utilizan este proceso:
 * <ol>
 * <li>Se inicia una transacci贸n</li>
 * <li>Invocaci贸n de {@link #populateTable()} que crea los datos de prueba</li>
 * <li>Se invoca a los m茅todos que est谩n marcados con {@literal @}{@link Before}
 * </li>
 * <li>Se invoca al m茅todo</li>
 * <li>Se hace un rollback de la transacci贸n</li>
 * </ol>
 * </p>
 * <p>
 ...
 * anotaciones indican que todos los {@literal @}{@link Test} ser谩n ejecutados
 * como una transacci贸n independiente, si se desea que un test no realice
 * rollback, se puede utilizar la anotaci贸n {@literal @}{@link Rollback} pasando
 * como {@link Rollback#value()} <code>false</code>
 * </p>
 * 
 * <p>
 * Una clase que desee hacer test deber谩 ser como sigue:
 * 
 * <pre>
 ...
 * 	}
 * 
 * 	{@literal @}{@link Autowired}	// Podemos inyectar el bean que creamos m谩s arriba
 * 	MyBean mybean;
 * 
 * 	{@literal @}{@link Test}
 ...
 * </p>
 * <p>
 * Se utiliza una configuraci贸n independiente por cada
 * {@link BaseTestWithDatabase} para intentar que sean lo mas independientes
 * unos de otros. En t茅rminos de rendimiento, no hay demasiado detrimento, pues
 * la mayor铆a de los componentes son cacheados en memoria.
 * </p>
 * <p>
 * Al utilizar una configuraci贸n que herede de
 * {@link TransactionTestConfiguration} se disponibilizan en el contexto (via
 * {@link Autowired}) la mayor铆a de los {@link Bean} que forman parte de Karaku
