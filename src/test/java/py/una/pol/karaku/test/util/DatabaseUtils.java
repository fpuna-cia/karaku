...
public class DatabaseUtils {
	...
	/**
	 * Ejecuta el DDL pasado, una vez por valor en el parÃ¡metro params.
	 *
	 * <p>
	 * Ejemplo de uso: Supongamos que deseamos crear una lista de secuencias,
	 * entonces utilizamos el siguiente cÃ³digo:
	 *
	 * <pre>
	 ...
	 * </pre>
	 *
	 * <h1>No se debe ejecutar este mÃ©todo dentro de una transacciÃ³n, pues el
	 * mismo la comitea</h1>
	 *
	 * @param testContext
	 * @param sequences
