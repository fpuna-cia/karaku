 ...
 * Copyright (c)
 *
 * 		2012-2014, Facultad PolitÈcnica, Universidad Nacional de AsunciÛn.
 * 		2012-2014, Facultad de Ciencias MÈdicas, Universidad Nacional de AsunciÛn.
 * 		2012-2013, Centro Nacional de ComputaciÛn, Universidad Nacional de AsunciÛn.
 *
 ...
 * <p>
 * Crea por defecto una base de datos H2, sin ning√∫n dato, solamente las
...
public class TransactionTestConfiguration extends BaseTestConfiguration {
	 ...
	 * presente como valor de una propiedad, entonces ser√° evaluada como
	 * <code>false</code>
	 */
	...
	/**
	 * Retorna la lista de paquetes que ser√°n exploradas por esta
	 * configuraci√≥n.
	 * <p>
	 ...
	 * </p>
	 * 
	 * @return lista de paquetes, si retorna <code>null</code>, el m√©todo
	...
	/**
	 * Retorna la lista de paquetes que ser√°n exploradas por esta
	 * configuraci√≥n. Si este m√©todo no retorna <code>null</code>, entonces el
	 * m√©todo {@link #getBasePackageToScan()} es omitido.
	 * <p>
	 * Por defecto retorna null.
	 * </p>
	 * 
	 * 
	 * @return lista de entidades, si retorna <code>null</code>, el m√©todo
