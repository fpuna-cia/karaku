...
public class ReportBuilderTest extends BaseTest {
	...
	public void testBefore() {
		...
		i18nHelper.addString("TITLE", "Ficha M̩dica");
	}
	...
	public void testSetMaster() {
		...
		assertEquals("Ficha M̩dica", builder.getParams().get("titleReport"));
	...
	public void testAddDetail() {
		...
		assertEquals("Tel̩fonos", builder.getDetails().get(0).getTitle());
	}
	...
	protected KarakuReportBlockGrid getBlockGrid() {
		...
		columns.add(new Column("N̼mero", "numero"));

		KarakuReportBlockGrid block = new KarakuReportBlockGrid("Tel̩fonos",
