/*
 * @AuditorTest.java 1.0 04/04/2014 Sistema Integral de Gestion Hospitalaria
 */
...
import py.una.pol.karaku.audit.Auditor;
...
public class AuditorTest extends BaseTestWithDatabase {
