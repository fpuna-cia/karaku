/**
 * @IKarakuBaseController 1.0 20/02/13. Sistema Integral de Gestion Hospitalaria
 */
 ...
 * @see KarakuBaseController KarakuBaseController, implementación que no utiliza
 *      reflexion.
...
public interface IKarakuBaseController<T, K extends Serializable> extends
	 ...
	 * {@link IKarakuBaseController} en un momento dado.
	 * 
	 * @author Arturo Volpe
	 * @since 1.0
	...
	static enum Mode {
		 ...
		 * editar y buscar.
		 * 
		 * @see IKarakuBaseController#isList()
		 */
		LIST,
		/**
		 ...
		 * 
		 * @see IKarakuBaseController#isView()
		 */
		VIEW,
		/**
		 * Determina si el controlador esta en modo de edición, en este modo el
		 * {@link IKarakuBaseController#getBean()} es editable, y no se realizan
		 * ningún tipo de búsquedas
		 * 
		 * @see IKarakuBaseController#isEdit()
		 * @see IKarakuBaseController#doEdit()
		 */
		EDIT,
		/**
		 ...
		 * el {@link IKarakuBaseController#getBean()} no es editable.
		 * 
		 * @see IKarakuBaseController#isDelete()
		 * @see IKarakuBaseController#doDelete()
		 */
		DELETE;
