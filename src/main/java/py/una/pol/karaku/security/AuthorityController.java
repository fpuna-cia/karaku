...
public class AuthorityController {
     ...
     * {@link KarakuPermission}), compara el permiso que da cada una de esas
     * autoridades con el permiso solicitado, si no tiene el permiso retorna
     * falso, y loguea un mensaje de error
     * 
     * @param rol
     *            a probar
    ...
    public String getUsername() {
        ...
        return notNull(SecurityContextHolder.getContext().getAuthentication()
                .getName().toUpperCase(), "Can't get the current username");
    }
